...
describe("store navigation mega menu", () => {
  ...
  it("uses the requested premium white overlay motion and geometry", () => {
    ...
    expect(globals).toContain("border-radius: 24px");
    expect(globals).toContain("background: #ffffff");
    expect(globals).toContain("box-shadow: 0 30px 80px rgba(0, 0, 0, 0.08)");
