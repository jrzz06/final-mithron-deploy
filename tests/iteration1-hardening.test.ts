...
describe("iteration 1 production hardening contracts", () => {
  ...
  it("exposes stable QA anchors for operational route families", () => {
    ...
    const warehouseShipmentsPage = readWorkspaceFile("app/warehouse/shipments/page.tsx");
    const warehouseShipmentDetailPage = readWorkspaceFile("app/warehouse/shipments/[id]/page.tsx");
