...
describe("home landing composite contract", () => {
  ...
  it("intentionally renders Drone World, Drone Care, and Global Products as catalog-backed shelves", () => {
    ...
    expect(component).toContain("Pilot Registration");
    expect(component).toContain("Drone Owner Registration");
    expect(component).toContain("Smart Farmer Registration");
    expect(component).toContain("Drone Loan and EMI");
    expect(component).toContain("Farmer Drone Booking");
    ...
    expect(component).toContain("FranchiseCare Center");
    expect(component).toContain("Drone Academic");
    expect(component).toContain("Technician Network");
