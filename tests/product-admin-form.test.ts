...
describe("product admin draft form", () => {
  ...
  it("wires the draft-only product form to the server action and admin page without changing storefront loaders", () => {
    ...
    expect(pageSource).toContain("uniqueCategoryOptions");
    ...
    const categoryFieldSource = readFileSync(join(process.cwd(), "app/admin/products/product-category-field.tsx"), "utf8");
